                    ...
                    <div class="box_1">
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                                ...
                                <div class="goodsItem">
                                    <a href="#"><<?php echo (IMG_URL); ?> src="<?php echo (IMG_URL); ?>17_thumb_G_1241969394587.jpg" alt="夏新N7" class="goodsimg"></a><br />
                                ...
                                <div class="goodsItem">
                                    ...
                                    <a href="#"><img src="<?php echo (IMG_URL); ?>goumai.gif"></a> &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="#;"><<?php echo (IMG_URL); ?> src="<?php echo (IMG_URL); ?>shoucang.gif"></a>
                                </div>
                            </div>
                        </form>
